...
export const ChatRoomSidebar: React.FC = () => {
  ...
  return (
    <aside className="items-stretch border-[color:var(--Wave-Zero,#44DFE9)] bg-[#1A2428] self-stretch flex min-w-60 flex-col w-[569px] my-auto pb-[38px] rounded-[17px] border-[5px] border-solid max-md:max-w-full">
      <div className="flex w-full flex-col items-center text-white max-md:max-w-full">
        <header className="justify-between items-center border-b-[color:var(--Yammy,#ABABF9)] flex min-h-[150px] max-w-full w-[569px] overflow-hidden text-center px-4 border-b border-solid">
        ...
        <div className="justify-center border-[color:var(--Yammy,#ABABF9)] bg-[rgba(255,255,255,0.11)] flex min-h-[100px] w-[524px] max-w-full flex-col text-2xl font-[510] mt-[18px] p-4 rounded-2xl border-2 border-solid">
          ...
          >
            <img
              src="https://cdn.builder.io/api/v1/image/assets/6f2aebc9bb734d979c603aa774a20c1a/44249b1395a83d759e1614049fa435929d69dd4c?placeholderIfAbsent=true"
        ...
        <div className="w-[524px] max-w-full text-2xl font-[510] mt-[18px]">
          ...
          <AIPluginCard
            ...
            onClick={() => console.log('Welcome AI Agent selected')}
          />
          ...
          <AIPluginCard
            ...
            onClick={() => console.log('Trivia AI Plugin selected')}
          />
          ...
          <AIPluginCard
            ...
            onClick={() => console.log('Faucet AI Agent Plugin selected')}
          />
        </div>
      </div>
      ...
      <footer className="self-center flex w-[474px] max-w-full flex-col items-center font-bold text-center mt-[182px] max-md:mt-10">
        ...
        <button 
          className="border-[color:var(--Yammy,#ABABF9)] bg-[linear-gradient(180deg,#ECECFF_0%,#E1E1FE_100%)] w-full overflow-hidden text-2xl text-black leading-none px-[70px] py-[29px] rounded-lg border-2 border-solid hover:opacity-80 transition-opacity max-md:px-5"
